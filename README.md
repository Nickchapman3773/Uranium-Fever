...
- `Navigate` to the NVIDIA app settings and `turn off NVIDIA overlay` (found in settings > General > In-Game Overlay), as the overlay will cause a black screen if used alongside Special K.
