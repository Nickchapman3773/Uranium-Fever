...
- MOST users will not have to follow these instructions. The most updated version of DXVK has already been **pre-installed** in Uranium Fever. Those with older graphics cards (Intel iGPU or no Vulkanless functionity) should follow these instructions if unable to launch the game:
	- Intel iGPU users:
...
> [!tip]
> This is an OPTIONAL step for those with weaker computers. Use the Performance Profile for far better performance in exchange for far worse visuals. This profile disables Real Time Reflections, New Vegas Reloaded, and other associated mods.
