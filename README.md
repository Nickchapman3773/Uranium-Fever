...
- A <a href="https://users.nexusmods.com/register" onclick="window.open('https://users.nexusmods.com/register', '_self');">Nexus Mods account</a> - Premium subscription is **HIGHLY** recommended, otherwise ~900 mods will need to be manually downloaded.
