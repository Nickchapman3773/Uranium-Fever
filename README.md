...
- <a href="www.techpowerup.com/download/visual-c-redistributable-runtime-package-all-in-one" onclick="window.open('www.techpowerup.com/download/visual-c-redistributable-runtime-package-all-in-one', '_self');">Visual C++</a>. Extract the archive, open the extracted folder, right click install_all.bat, and select run as administrator.
