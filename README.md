...
- MOST users will not have to follow these instructions. The most updated version of DXVK has already been **pre-installed** in Uranium Fever. Those with older graphics cards (Intel iGPU or no Vulkan functionity) should follow these instructions if unable to launch the game:
	- Intel iGPU users:
