...
- **StrawChannel95** for creating the `uraniumfever.json` file, consulting on technical aspects of Wabbajack, heavily editing these instructions, and prototyping the [Resources](https://uraniumfever.net/docs/resources/overview) section.
