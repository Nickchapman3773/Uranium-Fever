...
- **StrawChannel95** for creating the `Manual Downloads.bat` file, `uraniumfever.json` file, and consulting on technical aspects of Wabbajack, heavily editing these instructions and prototyping the [Resources](https://uraniumfever.net/docs/resourcesoverview) section.
