...
- Windows 10 or higher (64-bit).
	- Uranium Fever is compatible with Linux, and specialized instructions are included below; however, access to Windows remains a **REQUIREMENT** for the Linux installation process.
