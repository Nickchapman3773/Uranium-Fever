...
NVIDIA graphics card users with the 50xx series card should install the [Community Vulkan Compatibility Driver](https://github.com/marekzajac97/nvgpucomp32_patch), as the current driver version is incompatible with DXVK. This driver patch has been validated and serves as an appropriate interval solution until the official NVIDIA fix is released.
:::
