...
- **NEW - 1.4.0.0**: For updates from pre-1.4.0.0 versions, a **NEW INSTALLATION** and **NEW SAVE** are **BOTH REQUIRED**. **A COMPLETE reinstallation is MANDATORY and NON-NEGOTIABLE, as many installation instructions have changed**.
